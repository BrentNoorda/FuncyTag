...
(b="\r\n");0!==k.length&&(a+=' style="'+k+'"');e&&(null===h&&(h=E(),this._attributes.id=h,a+=' id="'+h+'"'),B&&h in n&&alert('FuncyTags adding id "'+h+'" when previous "'+h+'" has not initialized yet.'),h in p&&x(h,!1),n[h]=this._attributes,null===l&&(l=setTimeout(A,0)));g="";k=this._attributes._nobrin?"":b+"  ";f=!1;for(d=0;d<this._insides.length;d++)for(h=this._insides[d],z(h)||(h=[h]),c=0;c<h.length;c++)if(e=h[c],null!=e)try{g+=e._ft_render_(f?"":k),f=e._attributes._nobrout}catch(m){f?f=!1:g+=
k,g+=String(e)}return a=0!==g.length||this._attributes._noslfcls?a+(">"+g+(this._attributes._nobrin?"":b)+"</"+this._ft_name+">"):a+"/>"};c.toString=function(){return this._ft_render_("")};c.createElement=function(){return q.createElement(this)};return c};c._ft_name=d;c.default_attributes=b;return c}var y,m,v,r,n,p,s,l,u,B=!0;y=RegExp("([A-Z])","g");f.prototype.mix=function(a,b){var d=1-b;return k(Math.round(this._.r*b+a._.r*d),Math.round(this._.g*b+a._.g*d),Math.round(this._.b*b+a._.b*d),Math.round(this._.a*
