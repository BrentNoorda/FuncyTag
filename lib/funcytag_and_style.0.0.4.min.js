...
z(f)||(f=[f]),e=0;e<f.length;e++)if(l=f[e],null!=l)if("_fs_selector"in l)for(C in l)m[C]=l.properties[C];else for(d in l)g=l[d],null!=g&&(I(g)?m._nested.push([d,g]):m[d]=g);m._fs_selector=a;m._fs_render_=function(a){var b,d,c,e,f;a=(a?a+" ":"")+m._fs_selector;b=a+" {\r\n";for(d in this)if(e=d.indexOf("_"),0!==e){c=this[d];-1===e?f="":(e=d.lastIndexOf("_"),f=d.substring(e+1),d=d.substring(0,e),"pct"===f&&(f="%"));if(z(c)){for(e=0;e<c.length;e++)null==c[e]&&(c.splice(e,1),e--);if(0===c.length)continue;
c=c.join(f+" ")}c+=f;b+="  "+G(d)+": "+c+";\r\n"}b+="}";A++;for(c=0;c<this._nested.length;c++)d=this._nested[c][0],g=this._nested[c][1],d=0===d.lastIndexOf("&",0)?d.substring(1):" "+d,J=u(a+d,g),b+="\r\n"+J._fs_render_(null);A--;return b};if(0===A)try{n.funcyTag._styles_not_injected.push(m)}catch(N){}return m}function M(){function a(b){var c=!0,e;0===b?c=!1:(e=v.charAt(b-1),"z"===e?(e="a",c=a(b-1)):e=String.fromCharCode(e.charCodeAt(0)+1),v=v.substring(0,b-1)+e);return c}var b=v+x+"-ft-unq";"z"===
x?(a(D)||(D++,v+="a"),x="a"):x=String.fromCharCode(x.charCodeAt(0)+1);return b}function K(){function a(b,a){return function(d){a.call(b,document.getElementById(b.id),d||n.event)}}var b,d,c,e,l;r=null;for(b in s)if(d=document.getElementById(b),null!==d){c=t[b]=s[b];delete s[b];for(e in c)0===e.lastIndexOf("on",0)&&"oninit"!==e&&"onterm"!==e&&(l=c[e],d.addEventListener?d.addEventListener(e.substring(2),a(c,l),!1):d.attachEvent(e,a(c,l)));"oninit"in c&&c.oninit.call(c,d)}if(null===r)for(b in s){if(E)try{console.log("RERENDER because something not ready yet")}catch(m){}r=
setTimeout(K,0)}}function F(a,b){var d=t[a];delete t[a];"onterm"in d&&d.onterm.call(d,b)}function L(){var a,b;y=null;for(a in t)b=document.getElementById(a),null===b&&F(a,!1);y=setTimeout(L,1E3)}function w(a,b){var d,c;try{if("_ft_name"in a&&(d=a._ft_name,void 0!==a.default_attributes))for(c in b=b||{},b._superAttr=a.default_attributes,a.default_attributes)c in b||(b[c]=a.default_attributes[c])}catch(e){d=a}c=function(a){var c,e,g;g=I(a);c={_ft_name:d,_insides:[],_attributes:g?a:{}};if(void 0!==b){c._attributes=
...
c),"pct"===f&&(f="%")),0===d.lastIndexOf("on",0))e=!0;else{if(z(h)){for(c=0;c<h.length;c++)null==h[c]&&(h.splice(c,1),c--);if(0===h.length)continue;h=h.join(f+" ")}h+=f;0===d.lastIndexOf("css",0)?g+=G(d).substring(4)+":"+h+";":(a+=" "+d+'="'+h+'"',"id"===d&&(k=h))}this._attributes._nobrout||(a=b+a);0!==b.length||this._attributes._nobrin||(b="\r\n");0!==g.length&&(a+=' style="'+g+'"');if(e){null===k&&(k=M(),this._attributes.id=k,a+=' id="'+k+'"');if(E&&k in s)try{console.warning('FuncyTags adding id "'+
k+'" when previous "'+k+'" has not initialized yet.')}catch(l){}k in t&&F(k,!1);s[k]=this._attributes;null===r&&(r=setTimeout(K,0))}h="";g=this._attributes._nobrin?"":b+"  ";f=!1;for(d=0;d<this._insides.length;d++)for(k=this._insides[d],z(k)||(k=[k]),c=0;c<k.length;c++)if(e=k[c],null!=e)try{h+=e._ft_render_(f?"":g),f=e._attributes._nobrout}catch(m){f?f=!1:h+=g,h+=String(e)}return a=0!==h.length||this._attributes._noslfcls?a+(">"+h+(this._attributes._nobrin?"":b)+"</"+this._ft_name+">"):a+"/>"};c.toString=
