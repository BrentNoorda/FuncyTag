    ...
    function funcyTag(name_or_funcytag,default_attributes)
    {
        ...
        try
        {
            if ( '_ft_name' in name_or_funcytag )
            {
                ...
                for ( xprop in name_or_funcytag._default_attributes )
                {
                    if ( !(xprop in default_attributes) )
                    {
                        default_attributes[xprop] = name_or_funcytag._default_attributes[xprop];
                    }
                }
            }
        } catch(e) {
        ...
        tag._ft_name = name;
        tag._default_attributes = default_attributes;
        return tag;
    }
