    ...
    function funcyTag(name,default_attributes)
    {
        var tag = function(attributes/*,inside1,inside2...*/) {
            ...
            tagobj._ft_render_ = function(stringPadding,depth) {
                ...
                if ( (stringPadding.length === 0) && !this._attributes._nobr_inner_ )
                {
                    stringPadding = '\r\n';
                }
                ...
                innerHTML = '';
                innerPadding = this._attributes._nobr_inner_ ? '' : (stringPadding + '  ');
                    ...
                    for ( jdx = 0; jdx < inside.length; jdx++ )
                    {
                        ...
                        if ( content !== undefined )
                        {
                            try {
                                ...
                                innerHTML += innerPadding + String(content);
                            }
                        }
                    }
                }
                ...
                {
                    html += '>' + innerHTML + ((this._attributes._nobr_inner_) ? '' : stringPadding) + '</' + this._name + '>';
                }
                return html;
            };
