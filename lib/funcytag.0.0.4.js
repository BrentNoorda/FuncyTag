...
(function(window) {
    var gCamelToDashRegexp, gNextUniqueId, gNextIdChar;
    ...
    var gNextUniqueId = "";  // each time an id isn't supplied, and we need one, supply it here
    var gUniqueLen = 0;
    var gNextIdChar = 'a'; // will roll among all the characters of the alphabet
